/* 	Changing the Intro Line
	...
	Thoughts (.what)
	---------
	ideas, musings, concepts, links, stuff, stories, projects

	Developer (.who)
	----------
	Mad Man, Scientist, Technologist, individual, odd human being
*/
...
function IntroLine(){
	...
	function pickWord(array, len){
		var i;
		len = len - 1;
		i = Math.floor(Math.random() * (len - 0 + 1)) + 0;
		return array[i];
	}
...
setInterval(IntroLine, 10000); // Change Introduction Line Changes every 10 seconds
